...
var resizePizzas = function(size) {
    ...
    function changeSliderLabel(size) {
      var pizzaSelect = document.getElementById("pizzaSize");
        switch (size) {
            case "1":
                pizzaSelect.innerHTML = "Small";
                return;
            case "2":
                pizzaSelect.innerHTML = "Medium";
                return;
            case "3":
                pizzaSelect.innerHTML = "Large";
                return;
            default:
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    var s = 256;
    var elem;
    var movePizza = document.getElementById("movingPizzas1");
    for (var i = 0; i < 35; i++) {
